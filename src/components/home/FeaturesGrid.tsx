...
export default function FeaturesGrid() {
  return (
    <section className="py-24 bg-[var(--bg-deep)] relative overflow-hidden isolate">
      ...
      <div className="container-xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map((feature, i) => (
            <div 
              key={i} 
              className="group bg-[#151e2e]/80 backdrop-blur-sm border border-slate-700/50 hover:border-blue-500/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(59,130,246,0.1)] flex flex-col items-center text-center"
            >
              <div className="w-16 h-16 rounded-xl bg-blue-500/10 flex items-center justify-center mb-6 text-blue-400 group-hover:text-cyan-400 group-hover:scale-110 group-hover:bg-blue-500/20 transition-all duration-300">
